...
from data import RiconvDataset, collation_fn_contiguous
...
if __name__ == "__main__":
    ...
    dataset = RiconvDataset(cfg["dataset_dir"], cfg["dataset_file"], normalize=True)
    dataloader = DataLoader(
        dataset=dataset,
        batch_size=cfg["batch_size"],
        collate_fn=collation_fn_contiguous,
